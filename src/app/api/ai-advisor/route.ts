...
export async function POST(request: Request) {
  try {
    ...
    if (isChatMode) {
      systemInstructionText = `คุณคือ "เพื่อนคู่คิดการเงิน (SmartSlip Financial Buddy)" หรือโค้ชการเงินส่วนตัวที่เป็นกันเองสุดๆ สนทนากับผู้ใช้เหมือนเป็นรุ่นพี่หรือเพื่อนสนิทที่พร้อมให้คำปรึกษาเรื่องเงินและช่วยปรับพฤติกรรมออมเงินจริงๆ ไม่ใช่บอทหุ่นยนต์ตอบคำถามแบบทางการ
